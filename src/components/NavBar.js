...
import { TwitterIcon, GithubIcon, LinkedInIcon, InstagramIcon, SunIcon, MoonIcon } from './icons';
  ...
  return (
    ...
    ">
        <button className="flex-col justify-center items-center hidden lg:flex" onClick={handleClick}>
            <span className={`bg-dark dark:bg-light block translate-all duration-300 ease-out h-0.5 w-6 rounded-sm -translate-y-0.5 ${isOpen ? 'rotate-45 translate-y-1': '-translate-y-0.5'}`}></span>
        ...
        <div className="w-full flex justify-between items-center lg:hidden">
            ...
            <motion.a href="https://github.com/Hariesh-Kai" target='_blank' 
                whileHover={{y:-2}}
                whileTap={{scale:0.9}}
                className="w-6 mr-3"
            >
            ...
            <motion.a href="https://www.linkedin.com/in/hariesh-r/" target='_blank'
                whileHover={{y:-2}}
                whileTap={{scale:0.9}}
                className="w-6 mx-3"
            >
