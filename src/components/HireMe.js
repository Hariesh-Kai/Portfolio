...
import { Circular_Text } from './icons'
  ...
  return (
    ...
    sm:right-0'>
        <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
            <Circular_Text className={'fill-dark animate-spin-slow dark:fill-light'} />
        </div>
      <Link href="mailto:harieshkai@gmail.com" className="flex items-center justify-center 
      absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark text-light
      shadow-md border border-solid border-dark w-20 h-20 
